...
export default function BillScreen() {
        ...
        render: () => {
          return (
            <Box bg="orange.300" px="2" py="1" rounded="sm" mb={5}>
              Không tìm thấy đơn hàng nào. Vui lòng liên hệ nhân viên bán hàng!
            </Box>
          );
        },
      });
  ...
  function send(id) {
    const mess = { idApp: getIdApp() };
    getStomptClient().send(
      `/topic/online-bill/${id}`,
      {},
      JSON.stringify(mess)
    );
  }
              ...
              return (
                <HStack
                  ...
                  <VStack p={3} style={{ flex: 1, alignItems: "flex-end" }}>
                    ...
                    <View style={{ height: 25, marginTop: 2, marginBottom: 5 }}>
                      <HStack>
                        <Text
                          style={{
                            fontWeight: "bold",
