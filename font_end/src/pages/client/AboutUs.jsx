        ...
        <Grid container spacing={2}>
          <Grid item xs={8}>
            ...
            <span style={{ fontSize: '14px', fontWeight: 500 }}>
              Thương hiệu thời trang nam F-Shoes được thành lập từ tháng 3 năm 2010, là thương hiệu
              thời trang uy tín hàng đầu tại Việt Nam dành riêng cho phái mạnh.
            </span>
            <div style={{ marginTop: '30px' }}>
              <span style={{ fontWeight: 1000, marginTop: '30px' }}>SỨ MỆNH:</span>
              <div style={{ fontSize: '14px', fontWeight: 500 }}>
                Không ngừng sáng tạo và tỉ mỉ từ công đoạn sản xuất đến các khâu dịch vụ, nhằm mang
                đến cho Quý Khách Hàng những trải nghiệm mua sắm đặc biệt nhất: sản phẩm chất lượng
                - dịch vụ hoàn hảo - xu hướng thời trang mới mẻ và tinh tế. Thông qua các sản phẩm
                thời trang, F-Shoes luôn mong muốn truyền tải đến bạn những thông điệp tốt đẹp cùng
